...
int main(void)
{
    ...
    pool.addObject(new Sphere(sf::Vector3f(0.75, -0.5, 10.5), sf::Color(255, 64, 64), 0.5, sf::Color::White, 5.0f));
    ...
    // pool.addLightPoint(lightPoint(sf::Vector3f(0.75, -0.5, 10.5), sf::Color::White, 1.0f));
