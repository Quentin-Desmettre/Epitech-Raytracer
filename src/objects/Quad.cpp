...
Quad::Quad(Vec3 point1, Vec3 point2, Vec3 point3, Vec3 point4,
...
void Quad::setPoint2(const Vec3 &point)
{
    _triangles[0].setPoint<1>(point);
    _triangles[3].setPoint<2>(point);
}

void Quad::setPoint3(const Vec3 &point)
{
...
void Quad::setPoint4(const Vec3 &point)
{
    _triangles[1].setPoint<2>(point);
    _triangles[2].setPoint<1>(point);
}

bool Quad::intersect(const Ray &ray, Vec3 &intersection) const
{
...
Vec3 Quad::getNormal(const Vec3 &inter, const Ray &ray) const
{
    Vec3 tmp;
